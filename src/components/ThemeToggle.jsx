...
export default function Navbar() {
  ...
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 w-full bg-[#0A0018]/80 backdrop-blur-md border-b border-white/5 z-50"
    >
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          >
            ...
            <motion.a
              ...
              className="text-white/60 hover:text-[#FD81C0] transition-colors duration-300"
